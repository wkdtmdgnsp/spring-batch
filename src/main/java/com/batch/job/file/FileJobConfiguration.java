package com.batch.job.file;

import com.batch.chunk.processor.FileItemProcessor;
...
public class FileJobConfiguration {
    ...
    @Bean
    public ItemProcessor<ProductV0, Product> fileItemProcessor() {
