...
public class ApiItemWriter1 extends FlatFileItemWriter<ApiRequestV0> {
    ...
    public void write(List<? extends ApiRequestV0> items) throws Exception {
        ...
        super.setResource(new FileSystemResource("C:\\study\\spring-batch\\src\\main\\resources\\produce1.txt"));
